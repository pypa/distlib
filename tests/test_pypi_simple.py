...
from distlib.compat import urllib2, HTTPError, httplib
from distlib.pypi.simple import Crawler

from compat import unittest
from support import TempdirManager, LoggingCatcher, fake_dec

try:
    import _thread
    from pypi_server import (use_pypi_server, PyPIServer,
...
class SimpleCrawlerTestCase(TempdirManager,
    ...
    def test_bad_urls(self, server):
        ...
        try:
            ...
            v.close()
            self.assertIsInstance(v, HTTPError)
