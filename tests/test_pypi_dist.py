...
from distlib.version import DefaultMatcher
...
from support import TempdirManager, requires_zlib, fake_dec
try:
    import threading
    from pypi_server import use_pypi_server
except ImportError:
    threading = None
...
class TestReleasesList(unittest.TestCase):
    ...
    def test_filter(self):
        ...
        filtered = releases.filter(DefaultMatcher("FooBar (<1.2)"))
