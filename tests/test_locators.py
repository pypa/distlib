...
class LocatorTestCase(unittest.TestCase):
    ...
    def test_dependency_finder(self):
        ...
        expected = set([
            ...
            'pytest'), ('setuptools', 'setuptools-scm', 'wcwidth',
            ...
            'hgtools', 'irc', 'pytest'), ('atomicwrites', 'setuptools',
            'importlib-metadata', 'attrs', 'wcwidth', 'more-itertools',
            'pyparsing', 'colorama', 'six', 'setuptools_scm',
            'setuptools-scm', 'pluggy', 'packaging', 'hgtools',
